...
- `src/fr/<source>/` — code source (Banchan Scan, Black Army, Meraki, Solaris, Yurei en `KeiSource` libVersion 1.6 ; ScanManga et Astral-Manga en `HttpSource` libVersion 1.4)
